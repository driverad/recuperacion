...
<%@ page import="java.util.List"%>
	<%@ page import="model.entity.*"%>
			<% Producto g =(Producto)request.getAttribute("products");%>
...
<body>
	...
	<div id="menu2">
		...
		<h2><%=g.getNombre()%>/<%=g.getId()%></h2>
		
	<form name="miFormulario" method="get" action="/products/update"
		onsubmit="return validar();">
		<input type="hidden" name="action" value="productCreatedDo" />
		...
		<p>Nombre:</p>
			...
			<p>Precio:</p>
			<input type="text" name="precio" value=<%=g.getPrecio()%>>
			<p>Cantidad:</p>
			<input type="text" name="cantidad"value=<%=g.getCantidad()%>>
